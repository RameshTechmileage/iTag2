...
public interface ITagRepository extends JpaRepository<ITagUser, Integer> {
	...
	@Query("select i from ITagUser i where i.reqParamKey1 = ?1 AND i.reqParamVal1 = ?2 AND i.reqParamKey2=?3 AND i.reqParamVal2=?4 AND i.reqParamKey3 = null AND i.reqParamVal3 = null")
	public ITagUser find(String reqParamKey1, String reqParamVal1, String reqParamKey2, String reqParamVal2);

	@Query("select i from ITagUser i where i.reqParamKey1 = ?1 AND i.reqParamVal1 = ?2 AND i.reqParamKey2=?3 AND i.reqParamVal2=?4 AND i.reqParamKey3=?5 AND i.reqParamVal3=?6")
	public ITagUser find(String reqParamKey1, String reqParamVal1, String reqParamKey2, String reqParamVal2,
			String reqParamKey3, String reqParamVal3);
	
	@Query("select i from ITagUser i where i.reqParamKey1 = ?1 AND i.reqParamVal1 = ?2 AND i.reqParamKey2 = null AND i.reqParamVal2 = null AND i.reqParamKey3 = null AND i.reqParamVal3 = null")
