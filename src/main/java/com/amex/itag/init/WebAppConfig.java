...
@ComponentScan("com.amex.itag")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.amex.itag.repository")
public class WebAppConfig extends WebMvcConfigurerAdapter{
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		// int cachePeriod = 3600 * 24 * 15;
		    registry.addResourceHandler("/static/**").addResourceLocations("/WEB-INF/static/");//.setCachePeriod(cachePeriod);
	...
	@Override
	 public void addCorsMappings(CorsRegistry registry) {
	  registry.addMapping("/**");
	  registry.addMapping("/getDataLayer");
	 }
