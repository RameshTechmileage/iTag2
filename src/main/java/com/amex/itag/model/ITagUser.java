...
public class ITagUser {
	 ...
	 * 
	 * @Column(name = "data_layer") private String dataLayer;
	 * 
	 * @Column(name = "request_parameter") private String requestParameter;
	 * 
	 ...
	 * }
	 * 
	 * public String getRequestParameter() { return requestParameter; }
	 * 
	 ...
	 * 
	 * @Column(name = "user_json") private String userInfoJson;
	 * 
	 * public Integer getId() { return id; }
	 * 
	 * public void setId(Integer id) { this.id = id; }
	 ...
	 * 
	 * public void setUserInfoJson(String userInfoJson) { this.userInfoJson =
	 * userInfoJson; }
	 */
}
